    ...
    <div class="container">
        <div class="main-slider">
            ...
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="fontend/img/flexslider/1.png" alt="MyPassion" />
                    ...
                    <li>
                        <img src="fontend/img/flexslider/3.png" alt="MyPassion" />
                    ...
                    <li>
                        <img src="fontend/img/flexslider/5.png" alt="MyPassion" />
                    ...
                    <li>
                        <img src="fontend/img/flexslider/4.png" alt="MyPassion" />
                    ...
                    <li>
                        <img src="fontend/img/flexslider/2.png" alt="MyPassion" />
        ...
        <div class="slider2">
            ...
            <a href="#"><img src="fontend/img/flexslider/6.png" alt="MyPassion" /></a>
        ...
        <div class="slider3">
            <a href="#"><img src="fontend/img/trash/3.png" alt="MyPassion" /></a>
            <p class="caption"><a href="#">Happy Birthday, blue jeans! </a></p>
        </div>

        <div class="slider3">
            <a href="#"><img src="fontend/img/trash/4.png" alt="MyPassion" /></a>
