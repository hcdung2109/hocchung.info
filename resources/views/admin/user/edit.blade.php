                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" data-widget-sortable="false">
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form method="POST" action="{{route('admin.user.update',$user)}}" id="smart-form-register" class="smart-form client-form">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <fieldset>
                                    <section>
                                        <label class="input"> <i class="icon-append fa fa-user"></i>
                                            <input value="{{ $user->name }}" type="text" name="name" placeholder="{{__('admin.username')}}">
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="label">{{__('admin.new_password')}}</label>
                                    ...
                                    <section >
                                        ...
                                        <label class="select">
                                            <select name="is_active">
                                                ...
                                                <option {{ $user->is_active == STATUS_ACTIVE ? 'selected' : ''}} value="1">{{__('admin.active')}}</option>
                                                <option {{ $user->is_active == STATUS_DEACTIVE ? 'checked' : ''}} value="0">{{__('admin.pending')}}</option>
                                            </select> <i></i>
                                        </label>
                                        <div class="note">
