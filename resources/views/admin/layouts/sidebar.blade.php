        ...
        {{--<ul>--}}
            {{--<li class="top-menu-invisible">--}}
                {{--<a href="#">--}}
                    ...
                    {{--<span class="menu-item-parent">{{__('admin.table_category')}}</span>--}}
                {{--</a>--}}
                {{--<ul>--}}
                    {{--<li class="">--}}
                        {{--<a href="{{route('category.create')}}" title="Dashboard">--}}
                            {{--<i class="fa fa-lg fa-fw fa-gear"></i>--}}
                            {{--<span class="menu-item-parent">{{__('admin.create_new')}}</span>--}}
                        {{--</a>--}}
                    {{--</li>--}}
                    {{--<li class="">--}}
                        {{--<a href="{{route('category.index')}}" title="Dashboard">--}}
                            {{--<i class="fa fa-lg fa-fw fa-gear"></i>--}}
                            {{--<span class="menu-item-parent">{{__('admin.list')}}</span>--}}
                        {{--</a>--}}
                    {{--</li>--}}
                {{--</ul>--}}
            {{--</li>--}}
            ...
            {{--<li class="top-menu-invisible">--}}
                {{--<a href="#">--}}
                    {{--<i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i>--}}
                    {{--<span class="menu-item-parent">{{__('admin.table_article')}}</span>--}}
                {{--</a>--}}
                {{--<ul>--}}
                    {{--<li class="">--}}
