                                    ...
                                    <form method="POST" action="{{route('admin.role.update',$role)}}">
                                        ...
                                        <tr role="row">
                                            <th class="hasinput" rowspan="1" colspan="1">
                                                <input value="{{ $role->name }}" name="name" type="text" class="form-control" placeholder="{{__('admin.name')}}">
                                            </th>
                                            <th class="hasinput"  rowspan="1" colspan="1">
                                                <input value="{{ $role->display_name }}" name="display_name" type="text" class="form-control" placeholder="{{__('admin.display_name')}}">
                                            </th>
                                            <th class="hasinput" rowspan="1" colspan="1">
                                                <input value="{{ $role->description }}" name="description" type="text" class="form-control" placeholder="{{__('admin.description')}}">
                                            </th>
                                            <th class="hasinput"  rowspan="1" colspan="1">
