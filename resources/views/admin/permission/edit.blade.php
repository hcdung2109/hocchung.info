                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-6" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form action="{{route('admin.permission.update', $permission)}}" method="post" id="comment-form" class="smart-form" novalidate="novalidate">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <fieldset>
                                    <section class=" col-6">
                                        ...
                                        <label class="input">
                                            <input value="{{ $permission->table_name }}" type="text" name="table_name" placeholder="tên bảng dạng số nhiều vd : 'articles'">
                                        </label>
                                        <div class="note">
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input value="{{ $permission->display_name }}" type="text" name="display_name" placeholder="ví dụ 'Creat Post'">
                                            </label>
                                            <div class="note">
                                                @if ($errors->has('display_name'))
                                                    <span class="help-inline block txt-red">{{ $errors->first('display_name') }}</span>
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input value="{{ $permission->description }}" type="text" name="description" placeholder="nhập mô tả">
                                            </label>
                                        </section>
                                    </div>
