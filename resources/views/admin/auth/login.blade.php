...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="public/admin/css/demo.min.css">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 center-block" style="float: none !important; ">
                <div class="well no-padding">
                    <form action="{{ route('admin.login') }}" method="post" id="login-form" class="smart-form client-form">
                        {{ csrf_field() }}
                        <header style="text-transform: uppercase;text-align: center">{{__('admin.sign_in')}}</header>
                        <fieldset>
                            <section>
                        ...
                        <footer>
                            <button type="submit" class="btn btn-primary">{{__('admin.sign_in')}}</button>
                        </footer>
                    </form>
...
<script src="public/admin/js/plugin/pace/pace.min.js"></script>
...
<!-- JQUERY VALIDATE -->
<script src="public/adminadmin/js/plugin/jquery-validate/jquery.validate.min.js"></script>
